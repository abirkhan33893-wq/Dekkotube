...
fun LoginScreen(
    ...
    var email by remember { mutableStateOf("alex.rivera@dekkhotube.com") }
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "Sign in to continue watching and creating videos",
            ...
            Row(
                ...
                Text(
                    text = "Don't have a DekkhoTube account? ",
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                Text(
                    ...
                    modifier = Modifier
                        ...
                        .testTag("signup_navigation_link")
                )
            }
        }
    }
